...
class GalaxyInfo extends React.Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <div id="galaxy-info">
                ...
                <div className="galaxy-info__footer text-justify text-uppercase">
                    <div className="galaxy-info__footer__title leading-font">{this.props.nextChapterTimes.broadcastStartDate}</div>
                    <div className="galaxy-info__footer__subtitle subtitle-line-spacing">
                        <div>Next broadcast</div>
                        <div>on NTS / {this.props.nextChapterTimes.broadcastStartTime}</div>
                    </div>
                </div>
            </div>
        );
